...
class MethodsOfPaymentService @Inject() (referenceDataConnector: ReferenceDataConnector)(implicit ec: ExecutionContext) {

  def getMethodsOfPayment()(implicit hc: HeaderCarrier): Future[MethodOfPaymentList] =
