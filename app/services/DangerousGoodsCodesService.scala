...
class DangerousGoodsCodesService @Inject() (referenceDataConnector: ReferenceDataConnector)(implicit ec: ExecutionContext) {

  def getDangerousGoodsCodes()(implicit hc: HeaderCarrier): Future[DangerousGoodsCodeList] =
