...
class CircumstanceIndicatorsService @Inject() (referenceDataConnector: ReferenceDataConnector)(implicit ec: ExecutionContext) {

  def getCircumstanceIndicators()(implicit hc: HeaderCarrier): Future[CircumstanceIndicatorList] =
