...
case class SpecialMentionAdditionalInfoPage(itemIndex: Index, referenceIndex: Index) extends QuestionPage[String] {

  override def path: JsPath = JsPath \ items \ itemIndex.position \ specialMentions \ referenceIndex.position \ toString

  override def toString: String = "specialMentionAdditionalInfo"
}
