...
case class DepartureId(value: Int)

object DepartureId {

  implicit val formatsArrivalId: Format[DepartureId] = new Format[DepartureId] {
    ...
    override def writes(o: DepartureId): JsNumber = JsNumber(o.value)
  }
