...
case object Scenario5 extends UserAnswerScenario {
  ...
  val userAnswers: UserAnswers = UserAnswers(lrn, eoriNumber, Json.obj())
    ...
    /*
     * Item Details section - Item 2
     * */
    .unsafeSetVal(pages.ItemDescriptionPage(secondGoodItem))("ItemTwoDescription")
    .unsafeSetVal(pages.ItemTotalGrossMassPage(secondGoodItem))(25000.000)
    .unsafeSetVal(pages.AddTotalNetMassPage(secondGoodItem))(true)
    .unsafeSetVal(pages.TotalNetMassPage(secondGoodItem))("12342")
    .unsafeSetVal(pages.IsCommodityCodeKnownPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.CommodityCodePage(secondGoodItem))("ComoCode2")
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsignorEoriKnownPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsignorEoriNumberPage(secondGoodItem))("Conor123")
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsignorNamePage(secondGoodItem))("ConorName2")
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsignorAddressPage(secondGoodItem))(
      CommonAddress("ConorLine1", "ConorLine2", "ConorL3", Country(CountryCode("GA"), "SomethingCO"))
    )
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsigneeEoriKnownPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsigneeEoriNumberPage(secondGoodItem))("Conee123")
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsigneeNamePage(secondGoodItem))("ConeeName2")
    .unsafeSetVal(pages.addItems.traderDetails.TraderDetailsConsigneeAddressPage(secondGoodItem))(
      CommonAddress("ConeeLine1", "ConeeLine2", "ConeeL3", Country(CountryCode("GA"), "SomethingCE"))
    )
    .unsafeSetVal(pages.PackageTypePage(secondGoodItem, Index(0)))(PackageType(PackageType.bulkCodes.head, "GD1PKG1"))
    ...
    .unsafeSetVal(pages.PackageTypePage(secondGoodItem, Index(1)))(PackageType(PackageType.unpackedCodes.head, "GD1PKG2"))
    ...
    .unsafeSetVal(pages.addItems.DeclareMarkPage(secondGoodItem, Index(1)))("GD1PK2MK")
    .unsafeSetVal(pages.addItems.AddAnotherPackagePage(secondGoodItem))(true)
    .unsafeSetVal(pages.PackageTypePage(secondGoodItem, Index(2)))(PackageType("BAG", "GD1PKG3"))
    .unsafeSetVal(pages.addItems.HowManyPackagesPage(secondGoodItem, Index(2)))(2)
    .unsafeSetVal(pages.addItems.DeclareMarkPage(secondGoodItem, Index(2)))("GD1PK3MK")
    .unsafeSetVal(pages.addItems.containers.ContainerNumberPage(secondGoodItem, Index(0)))("GD1CN1NUM1")
    .unsafeSetVal(pages.addItems.containers.ContainerNumberPage(secondGoodItem, Index(1)))("GD1CN2NUMS")
    .unsafeSetVal(pages.addItems.specialMentions.AddSpecialMentionPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.specialMentions.SpecialMentionTypePage(secondGoodItem, Index(0)))("GD1S1")
    .unsafeSetVal(pages.addItems.specialMentions.SpecialMentionAdditionalInfoPage(secondGoodItem, Index(0)))("GD1SPMT1Info")
    .unsafeSetVal(pages.addItems.specialMentions.AddAnotherSpecialMentionPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.specialMentions.SpecialMentionTypePage(secondGoodItem, Index(1)))("GD1S2")
    .unsafeSetVal(pages.addItems.specialMentions.SpecialMentionAdditionalInfoPage(secondGoodItem, Index(1)))("GD1S2Info")
    ...
    .unsafeSetVal(pages.addItems.DocumentTypePage(secondGoodItem, Index(0)))("G1D1")
    .unsafeSetVal(pages.addItems.DocumentReferencePage(secondGoodItem, Index(0)))("G1D1Ref")
    .unsafeSetVal(pages.addItems.AddExtraDocumentInformationPage(secondGoodItem, Index(0)))(true)
    .unsafeSetVal(pages.addItems.DocumentExtraInformationPage(secondGoodItem, Index(0)))("G1D1Info")
    .unsafeSetVal(pages.addItems.AddAnotherDocumentPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.DocumentTypePage(secondGoodItem, Index(1)))("G1D2")
    .unsafeSetVal(pages.addItems.DocumentReferencePage(secondGoodItem, Index(1)))("G1D2Ref")
    .unsafeSetVal(pages.addItems.AddExtraDocumentInformationPage(secondGoodItem, Index(1)))(false)
    ...
    .unsafeSetVal(pages.addItems.ReferenceTypePage(secondGoodItem, Index(0)))("GD1PR1")
    .unsafeSetVal(pages.addItems.PreviousReferencePage(secondGoodItem, Index(0)))("GD1PR1Ref")
    .unsafeSetVal(pages.addItems.AddExtraInformationPage(secondGoodItem, Index(0)))(true)
    .unsafeSetVal(pages.addItems.ExtraInformationPage(secondGoodItem, Index(0)))("GD1PR1Info")
    .unsafeSetVal(pages.addItems.AddAnotherPreviousAdministrativeReferencePage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.ReferenceTypePage(secondGoodItem, Index(1)))("GD1PR2")
    ...
    .unsafeSetVal(pages.addItems.securityDetails.TransportChargesPage(secondGoodItem))(MethodOfPayment("W", "description"))
    ...
    .unsafeSetVal(pages.addItems.traderSecurityDetails.AddSecurityConsignorsEoriPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.traderSecurityDetails.SecurityConsignorEoriPage(secondGoodItem))("GD1SECCONOR")
    .unsafeSetVal(pages.addItems.traderSecurityDetails.AddSecurityConsigneesEoriPage(secondGoodItem))(true)
    .unsafeSetVal(pages.addItems.traderSecurityDetails.SecurityConsigneeEoriPage(secondGoodItem))("GD1SECCONEE")
