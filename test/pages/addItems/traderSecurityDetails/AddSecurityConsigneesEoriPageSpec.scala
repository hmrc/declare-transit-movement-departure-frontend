      ...
      forAll(arbitrary[UserAnswers]) {
        userAnswers =>
          val result = userAnswers
            ...
            .success
            .value
            .set(CommonAddItemsAddressPage(index, "securityConsigneeAddress"), consigneeAddress)
            .success
            .value
          ...
          result.get(CommonAddItemsAddressPage(index, "securityConsigneeAddress")) must not be defined
      }
    }
