...
class AddAnotherSpecialMentionFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "addAnotherSpecialMention.error.required"
  val invalidKey  = "error.boolean"

  val form = new AddAnotherSpecialMentionFormProvider()
