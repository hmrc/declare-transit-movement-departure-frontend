...
class SafetyAndSecurityConsignorEoriControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with NunjucksSupport with JsonMatchers {

  private val formProvider = new SafetyAndSecurityConsignorEoriFormProvider()
  private val form         = formProvider()
  private val template     = "safetyAndSecurity/safetyAndSecurityConsignorEori.njk"
