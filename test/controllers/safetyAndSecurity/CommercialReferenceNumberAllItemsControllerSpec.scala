...
class CommercialReferenceNumberAllItemsControllerSpec extends SpecBase with MockNunjucksRendererApp with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "CommercialReferenceNumberAllItems Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request        = FakeRequest(GET, commercialReferenceNumberAllItemsRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(CommercialReferenceNumberAllItemsPage, "answer").success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, commercialReferenceNumberAllItemsRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request        = FakeRequest(POST, commercialReferenceNumberAllItemsRoute).withFormUrlEncodedBody(("value", ""))
