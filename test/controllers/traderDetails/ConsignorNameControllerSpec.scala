...
import pages.traderDetails.ConsignorNamePage
...
class ConsignorNameControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with NunjucksSupport with JsonMatchers {
