...
class TraderDetailsCheckYourAnswersControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with JsonMatchers {

  "TraderDetailsCheckYourAnswers Controller" - {
