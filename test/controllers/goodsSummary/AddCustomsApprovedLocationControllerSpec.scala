...
class AddCustomsApprovedLocationControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "AddCustomsApprovedLocation Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      templateCaptor.getValue mustEqual "addCustomsApprovedLocation.njk"
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, addCustomsApprovedLocationRoute)
