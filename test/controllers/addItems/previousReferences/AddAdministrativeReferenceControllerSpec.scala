...
class AddAdministrativeReferenceControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "AddAdministrativeReference Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, addAdministrativeReferenceRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request                                = FakeRequest(POST, addAdministrativeReferenceRoute).withFormUrlEncodedBody(("value", ""))
