...
class TraderDetailsConsignorEoriKnownControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "TraderDetailsConsignorEoriKnown Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, traderDetailsConsignorEoriKnownRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request                                = FakeRequest(POST, traderDetailsConsignorEoriKnownRoute).withFormUrlEncodedBody(("value", ""))
